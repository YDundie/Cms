...
if(isset($_POST['update_post'])){
        ...
        $post_image_tem = $_FILES ['image'] ['tmp_name'];   
   ...
   <form action="" method="post" enctype="multipart/form-data">
       ...
       <div class="form-group">
        ...
        <select class="form-control" name="post_status">
                        ...
                        <option value="<?php echo $post_status; ?>"> Current status :<?php echo $post_status ?> </option>
        ...
        <div class="form-group" data-provides="fileinput">
         ...
         <img width="100" height="65" src="../images/<?php echo $post_image; ?>" alt="">
                  <hr> 
                ...
                <input  type="file" name="image" id="files" style="visibility:hidden;">
        ...
        <textarea name="post_content" class="form-control" id="summernote" cols="30" rows="25"><?php echo $post_content?></textarea>
