    ...
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-red">
          ...
          <?php
            ...
            $categorie_count = mysqli_num_rows($select_all_categorie);
  ...
  <?php 
   ...
   $query = "SELECT * FROM posts WHERE post_status = 'Draft'";
     ...
     $query = "SELECT * FROM comments WHERE comment_status = 'unapproved'";
            ...
            $post_unapproved_count = mysqli_num_rows($select_all_unapproved);           
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Data', 'Count' ],
            ...
            $element_count= [$post_count,$post_published_count,$post_draft_count,$comment_count,$post_unapproved_count,$user_count,$subs_count,$categorie_count];
